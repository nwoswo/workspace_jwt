...
public class DatabaseConfig {
    ...
    public HikariDataSource getDataSource(){
        ...
        dataSource.addDataSourceProperty("password", "ovelisco");
        return dataSource;
    }
    ...
    public HibernateTransactionManager transactionManager() {
        ...
        manager.setSessionFactory(hibernate4SessionFactoryBean().getObject());
        return manager;
    }

    @Bean(name = "sessionFactory")
    public LocalSessionFactoryBean hibernate4SessionFactoryBean(){
